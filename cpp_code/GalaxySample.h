...
class GalaxySample {
 ...
 public:
   ...
   GalaxySample(FlatInhomogeneousUniverseLCDM* universe, double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model);
   GalaxySample(FlatInhomogeneousUniverseLCDM* universe, string bias_and_shotnoise);
   ~GalaxySample();
   
   // setting class attributes
   void set_universe(FlatInhomogeneousUniverseLCDM* universe);
   void set_parameters(double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model);
 ...
 private:
   ...
   double alpha_2; // additional shot-noise parameter wrt. https://arxiv.org/abs/1710.05162
   ...
   vector<double> delta_table;
   vector<double> delta_g_table;
   vector<double> shot_noise_table;
