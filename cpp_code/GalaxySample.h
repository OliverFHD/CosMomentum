...
class GalaxySample {
 ...
 public:
   ...
   double return_P_of_N_given_delta_g(int N, double N_bar, double delta_m, double delta_g); // not guaranteed to be normalized

   void   store_N_delta_samples(double db_samples, int dn_samples, double *dN_samples, double *ddelta_m_samples);
   double return_P_of_N_given_delta_g_sampled(int N, double delta_g);
