...
GalaxySample3D::GalaxySample3D(FlatInhomogeneousUniverseLCDM* universe, double z, double density_in_Mpc_over_h_cubed, double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model) : GalaxySample(universe, b1, b2, a0, a1, a2, b_model){
...
GalaxySample3D::GalaxySample3D(FlatInhomogeneousUniverseLCDM* universe, double z, double density_in_Mpc_over_h_cubed, string bias_and_shotnoise) : GalaxySample(universe, bias_and_shotnoise){
...
void GalaxySample3D::set_parameters_3D(double z, double density_in_Mpc_over_h_cubed, double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model){
  this->density = density_in_Mpc_over_h_cubed*pow(constants::c_over_e5, 3); // changing from Mpc/h to units with c/H_0 == 1
  this->redshift = z;
