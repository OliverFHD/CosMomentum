...
class GalaxySample3D : public GalaxySample  {
 ...
 public:
   ...
   GalaxySample3D(FlatInhomogeneousUniverseLCDM* universe, double z, double density_in_Mpc_over_h_cubed, double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model);
   GalaxySample3D(FlatInhomogeneousUniverseLCDM* universe, double z, double density_in_Mpc_over_h_cubed, string bias_and_shotnoise);
   ~GalaxySample3D();
   
   void set_parameters_3D(double z, double density_in_Mpc_over_h_cubed, double b1, double b2, double a0, double a1, double a2, BIAS_MODEL b_model);
