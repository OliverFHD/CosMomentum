...
class ProjectedGalaxySample : public GalaxySample {
 ...
 public:
   ...
   ProjectedGalaxySample(FlatInhomogeneousUniverseLCDM* universe, double density_in_arcmin_squared, double b1, double b2, double a0, double a1, BIAS_MODEL b_model, string input_file);
   ~ProjectedGalaxySample();
   
   void set_n_of_w_data(string n_of_z_input_file);
   void set_parameters_projected(double density_in_arcmin_squared, double b1, double b2, double a0, double a1, BIAS_MODEL b_model, string input_file);
