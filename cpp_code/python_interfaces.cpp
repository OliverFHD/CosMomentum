...
extern "C" void return_P_of_N_given_delta_m(double* P_of_N_given_delta, double* delta, double* N, double N_bar, int npoints, int index_of_galaxy_sample){

  for(int i=0; i<npoints; i++){
    P_of_N_given_delta[i] = global_universes.galaxy_samples_3D[index_of_galaxy_sample]->return_P_of_N_given_delta_g(N[i], N_bar, delta[i], global_universes.galaxy_samples_3D[index_of_galaxy_sample]->linear_bias*delta[i]);
    // int N, double N_bar, double delta_m, double delta_g
  }
}
